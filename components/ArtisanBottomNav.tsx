    ...
    >
      <div
        className={`transition-colors select-none pointer-events-none ${
          isActive
            ? "text-[var(--color-primary-accent)] opacity-100"
...
const ArtisanBottomNav: React.FC<{
  activeTab: ArtisanTab;
  setActiveTab: (tab: ArtisanTab) => void;
  ...
  return (
    <nav
      className="fixed bottom-0 left-0 w-full z-20 h-20 flex items-center justify-around px-2 pb-2 bg-[var(--color-surface)] border-t border-[var(--color-border)]"
      style={{
    ...
    >
      <NavItem
        label={t("artisanNavDashboard")}
        tab={ArtisanTab.Dashboard}
        activeTab={activeTab}
      ...
      <NavItem
        label={t("artisanNavProducts")}
        tab={ArtisanTab.Products}
        activeTab={activeTab}
        setActiveTab={setActiveTab}
      >
        {({ isActive }) => (
      ...
      <NavItem
        label={t("artisanNavMessages")}
        tab={ArtisanTab.Messages}
        activeTab={activeTab}
        setActiveTab={setActiveTab}
      >
        {({ isActive }) => (
      ...
      <NavItem
        label={t("artisanNavOrders")}
        tab={ArtisanTab.Orders}
        activeTab={activeTab}
        setActiveTab={setActiveTab}
      >
        {({ isActive }) => (
      ...
      <NavItem
        label={t("artisanNavSettings")}
        tab={ArtisanTab.Settings}
        activeTab={activeTab}
        setActiveTab={setActiveTab}
      >
        {({ isActive }) => (
